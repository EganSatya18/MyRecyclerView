package www.smktelkommalang.myrecyclerview;
...
public class CardViewAdapter extends RecyclerView.Adapter<CardViewAdapter.CardViewHolder> {
    ...
    public CardViewAdapter(ArrayList<Hero> listHero){
    ...
    public void onBindViewHolder(@NonNull CardViewAdapter.CardViewHolder holder, int position) {
        ...
        Glide.with(holder.itemView.getContext()).load(hero.getPhoto()).apply(new RequestOptions().
                override(350, 550)).into(holder.imgPhoto);
